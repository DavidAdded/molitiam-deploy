          ...
          <div className="padding-section-large">
            <div className="verksamheter-content-wrapper">
              <div className="verksamheter-content-wrapper-top">
                <div className="verksamheter-text-wrapper">
                  <img src="/prefix-icon.svg" alt="Left" />
                  <h6> Verksamheter </h6>
                </div>
                <h2>CR Group</h2>
                <p>
                  CR Group är ett svenskägt cybersäkerhetsföretag med inriktning
                  mot Sverige och Europa. Vi erbjuder samhällsviktig verksamhet
                  lösningar som är både enkla att använda och enkla att köpa.
                </p>
                <p>
                  Gruppen består av helägda dotterbolag inom utvalda
                  expertområden med produkter och tjänster för säkerhetskritisk
                  verksamhet.
                </p>
                <p>
